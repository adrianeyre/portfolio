		...
		return <div className="text-container">
			<div className="row">
				{ this.props.imageName && this.props.imagePosition === 'left' && <div className="col-md-6">
					<img width="100%" height="100%" alt={ this.props.imageName } src={`/images/backgrounds/${ this.props.imageName }`} style={ this.styleImage() } />
				</div> }
				<div className={ this.props.imageName ? 'col-md-6' : 'col-md-12' }>
					{ this.state.data && this.state.data.map((item: IDataService, textIndex: number) => <article key={ `text-item-${ textIndex }` } className="text-item">
						<div className="title">
